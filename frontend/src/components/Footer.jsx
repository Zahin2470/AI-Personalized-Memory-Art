export default function Footer() {
  return (
    <footer className="border-t border-ink/10 bg-ink-fixed text-parchment-fixed">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <p className="font-display text-3xl italic">Memory Art</p>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-parchment-fixed/70">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-parchment-fixed/70">
              <li>Watercolor</li>
              <li>Oil Painting</li>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-parchment-fixed/10 pt-8 text-xs text-parchment-fixed/50 sm:flex-row sm:items-center">
